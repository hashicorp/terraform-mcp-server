...
| `MCP_TLS_CERT_FILE` | Location of the TLS certificate file (e.g. `/path/to/cert.pem`) | `""` (empty) |
| `MCP_TLS_KEY_FILE` |  Location of the TLS key file (e.g. `/path/to/key.pem`)| `""` (empty) |
