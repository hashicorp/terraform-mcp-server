...
func init() {
	...
	streamableHTTPCmd.Flags().String("endpoint-path", "/mcp", "Path for streamable HTTP endpoint")
	...
	httpCmdAlias.Flags().String("endpoint-path", "/mcp", "Path for streamable HTTP endpoint")
