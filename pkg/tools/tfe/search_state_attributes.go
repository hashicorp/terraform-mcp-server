...
// a workspace's current state. This is the tool #437 asks for directly: given natural
// language like "what's the current state of the assets S3 bucket", search by substring
// instead of the model having to fetch and scan the entire state itself.
