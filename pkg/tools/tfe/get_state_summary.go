...
// GetStateSummary creates a tool to generate a high-level, low-token summary of a
// workspace's current Terraform state: resource counts by type and module, and output
// names — a first pass before diving into specific resources with get_state_resource or
// search_state_attributes, instead of fetching the entire state to answer "what's in here".
