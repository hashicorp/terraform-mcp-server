...
* [New Tool] `delete_team` Permanently deletes a Terraform team by its `team_id`. Requires `team_id` (e.g. `team-xxxxxxxx`). This is a destructive operation and must set `ENABLE_TF_OPERATIONS=true`.
