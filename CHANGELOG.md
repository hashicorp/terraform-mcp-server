...
* [New Tool] `delete_project` Deletes a Terraform project by ID. Requires `project_id`. Gated behind `ENABLE_TF_OPERATIONS`. TFC/TFE will refuse to delete a project that still contains workspaces or stacks.
